package MyServletExamples.src.com.srivastava.apps;
...
public class WelcomeUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (session == null) {
			...
			out.println("<html><body bgcolor='" + color + "'>" + "<form action='" + newurl
					+ "'> <input type='submit' value='Logout'></form>" + "<h1>Welcome " + uid + "</h1></body></html>");
			out.close();
		}
	}
