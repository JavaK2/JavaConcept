...
public class Demo1 extends JFrame { // implements ActionListener {
	...
	Demo1() {
		 ...
		 * JOptionPane.showMessageDialog(Demo1.this,
		 * "U Click On Ok, Hello User");
		 * 
		 * } });
		 */
	...
	/*
	 * public void actionPerformed(ActionEvent e){ String msg = "";
	 * if(e.getActionCommand().equalsIgnoreCase("ok")){ msg = "Hello User"; }
	 * else { msg = "Welcome User"; } JOptionPane.showMessageDialog(this, msg);
	 * }
	 */
