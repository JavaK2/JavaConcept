...
public class MultipleControls extends JFrame {
	...
	public MultipleControls() {
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			/*
			 * @Override public void keyTyped(KeyEvent e) { String keyChar =
			 * String.valueOf(e.getKeyChar()); String keyCode =
	...
	private void askToClose() {
		int choice = JOptionPane.showConfirmDialog(this, "Do u want to close this window", "MyFrame-2016",
