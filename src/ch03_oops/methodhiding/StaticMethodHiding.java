package ch03_oops.methodhiding;
...
public class StaticMethodHiding {
	public static void main(String[] args) {
		...
		b.foo(); // should not be done. Prints Animal because the declared type
					// of b is Animal
		c.foo(); // should not be done. Prints Cat because the declared type of
					// c is Cat
		d.foo(); // should not be done. Prints Animal because the declared type
					// of b is Animal
	}
}
